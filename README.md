...
- [Download `thinkly-beta-v4.2.0-beta.4.zip`](https://github.com/pluglabai/thinkly-chrome-extension/releases/download/chrome-extension-beta-v4.2.0-beta.4/thinkly-beta-v4.2.0-beta.4.zip)
